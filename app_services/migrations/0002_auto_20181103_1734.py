# Generated by Django 2.1.3 on 2018-11-03 22:34
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='sqlquery',
            name='service',
            field=models.OneToOneField(limit_choices_to={'kind': '4'}, on_delete='CASCADE', primary_key=True, related_name='query', related_query_name='query', serialize=False, to='app_services.Service'),
        ),
    ]
